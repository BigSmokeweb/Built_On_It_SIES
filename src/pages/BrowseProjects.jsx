...
export default function Explore() {
  ...
  // Pre-apply topic filter from URL e.g. /explore?topic=Web
  useEffect(() => {
  ...
  const sorted = useMemo(() => {
    ...
    if (activeTab === 'Most Stars') list.sort((a, b) => b.stars_n - a.stars_n);
    else if (activeTab === 'Recent') list.sort((a, b) => a.time.localeCompare(b.time));
    else if (activeTab === 'Trending') list.sort((a, b) => b.stars_n - a.stars_n);
    return list;
  }, [activeTab]);
